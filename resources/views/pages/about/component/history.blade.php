<style>
    ...
    .time-line::after {
        ...
        height: 100%;
        width: 5px;
        background: linear-gradient(#1A3F6D, #1A3F6D);
        border-radius: 50px;
    ...
    .history-container {
        ...
        /* background: red; */
        padding: 10px 20px;
        animation: animate-history-container 0.5s linear forwards;
        opacity: 0;
        animation-delay: var(--dt);
    }

    @keyframes animate-history-container {
        0% {
            opacity: 0;
    ...
    .history-container:nth-child(odd)::before {
        content: '';
        top: 0;
        right: -7px;
        position: absolute;
    ...
    .history-container:nth-child(even)::before {
        content: '';
        top: 0;
        left: -12.2px;
        position: absolute;
    ...
    .content {
        ...
        border-radius: 10px;
        box-shadow: 0 5px 10px #1919196d;
        background: #1A3F6D;
    }
    ...
    <div class="his-heading">
       <h2>History</h2>
    </div>
    <section class="time-line">
        <div class="history-container" style="--dt:1s">
            <div class="content">
                <h2>2003</h2>
                <p>ProcessNet was established</p>
            </div>
        </div>
        <div class="history-container" style="--dt:2s">
            <div class="content">
                <h2>2005</h2>
                <p>OpenText partnership</p>
            </div>
        </div>
        <div class="history-container" style="--dt:3s">
            <div class="content">
                <h2>2007</h2>
                <p>Partnering with Resonate KT (UK) and GCI Inc. (US)</p>
            </div>
        </div>
        <div class="history-container" style="--dt:4s">
            <div class="content">
                <h2>2008</h2>
                <p>System Integrator Agreement with OpenText EMEA</p>
            </div>
        </div>
        <div class="history-container" style="--dt:5s">
            <div class="content">
                <h2>2010</h2>
                <p>Vertical solutions for Energy & Utilities</p>
            </div>
        </div>
        <div class="history-container" style="--dt:6s">
            <div class="content">
                <h2>2013</h2>
                <p>Project Document Console for Manufacturing</p>
            </div>
        </div>
        <div class="history-container" style="--dt:7s">
            <div class="content">
                <h2>2014</h2>
                <p>Augmented Information Management Framework for Capital Projects</p>
            </div>
        </div>
        <div class="history-container" style="--dt:8s">
            <div class="content">
                <h2>2016</h2>
                <p>Software development unit spin-off (ProjectVault)</p>
            </div>
        </div>
        <div class="history-container" style="--dt:9s">
            <div class="content">
                <h2>2020</h2>
                <p>Packaged Solutions for Project-driven business processes and for OpenText xECM for Engineering</p>
            </div>
        </div>
    </section>
    <script data-no-optimize="1">
        ...
        ! function(t, e) {
            ...
            function _(t, e) {
                et ? t.classList.remove(e) : t.className = t.className.replace(new RegExp("(^|\\s+)" + e + "(\\s+|$)"), " ").replace(/^\s+/, "").replace(/\s+$/, "")
            }
            ...
            function w(t, e, n) {
                ...
                (a = nt && o ? o : a) && (t.style.backgroundImage = a, n = n, f(t = t, (e = e).class_applied), s(t, dt), n && (e.unobserve_completed && v(t, e), d(e.callback_applied, t, n)))
            }
            ...
            function C(t, e, n) {
                var a;
                delete t.llTempImage, b(n, -1), (a = n) && --a.toLoadCount, _(t, e.class_loading), e.unobserve_completed && v(t, n)
            }
            ...
            function R(i, r, c) {
                ...
                N(l) || function(t, e, n) {
                    ...
                    var e, n, a, o;
                    n = r, a = c, o = u(e = i), C(e, n, a), f(e, n.class_loaded), s(e, ut), d(n.callback_loaded, e, a), o || x(n, a), z(l)
                }, function(t) {
                    var e, n, a, o;
                    n = r, a = c, o = u(e = i), C(e, n, a), f(e, n.class_error), s(e, ft), d(n.callback_error, e, a), o || x(n, a), z(l)
                })
            }
            ...
            function T(t, e, n) {
                ...
                }), i = n, r = l(a = t, (o = e).data_bg), c = l(a, o.data_bg_hidpi), (r = nt && c ? c : r) && (a.style.backgroundImage = 'url("'.concat(r, '")'), g(a).setAttribute(ot, r), k(a, o, i)), w(t, e, n)
            }
            ...
            function P(t, e) {
                var n;
                F(t), n = e, r(e = t) || u(e) || (_(e, n.class_entered), _(e, n.class_exited), _(e, n.class_applied), _(e, n.class_loading), _(e, n.class_loaded), _(e, n.class_error)), i(t), I(t)
            }
            ...
            function $(t, e, n, a) {
                ...
                s(t, "entered"), f(t, n.class_entered), _(t, n.class_exited), o = t, i = a, n.unobserve_entered && v(o, i), d(n.callback_enter, t, e, a), r || D(t, n, a)
            }
            ...
            function H(t, o, i) {
                t.forEach(function(t) {
                    return (a = t).isIntersecting || 0 < a.intersectionRatio ? $(t.target, t, o, i) : (e = t.target, n = t, a = o, t = i, void(r(e) || (f(e, a.class_exited), U(e, n, a, t), d(a.callback_exit, e, n, t))));
                    var e, n, a
                })
            }
            ...
            function B(e, n) {
                ...
                tt && !q(e) && (n._observer = new IntersectionObserver(function(t) {
                    ...
                    root: (t = e).history-container === document ? null : t.history-container,
            ...
            function K(t) {
                return t.history-container.querySelectorAll(t.elements_selector)
            }
            ...
            function t(t, e) {
                var n, a, t = o(t);
                this._settings = t, this.loadingCount = 0, B(t, this), n = t, a = this, Y && window.addEventListener("online", function() {
                    X(n, a)
                }), this.update(e)
            }
            var Y = "undefined" != typeof window,
                Z = Y && !("onscroll" in window) || "undefined" != typeof navigator && /(gle|ing|ro)bot|crawl|spider/i.test(navigator.userAgent),
                tt = Y && "IntersectionObserver" in window,
                et = Y && "classList" in document.createElement("p"),
                nt = Y && 1 < window.devicePixelRatio,
                at = {
                    elements_selector: ".lazy",
                    history-container: Z || Y ? document : null,
                    threshold: 300,
                    thresholds: null,
                    data_src: "src",
                    data_srcset: "srcset",
            ...
            return t.prototype = {
                update: function(t) {
                        ...
                        i = W(t, o);
                    {
                        ...
                        }), void p(n, 0)) : (t = this._observer, o = i, t.disconnect(), a = t, void o.forEach(function(t) {
                            a.observe(t)
                        }));
                        this.loadAll(i)
                    }
    ...
    <script data-no-optimize="1">
        ...
        litespeed_vary || (sessionStorage.getItem("litespeed_reloaded") ? console.log("LiteSpeed: skipping guest vary reload (already reloaded this session)") : fetch("/wp-content/plugins/litespeed-cache/guest.vary.php", {
            method: "POST",
            cache: "no-cache",
            redirect: "follow"
        }).then(e => e.json()).then(e => {
            console.log(e), e.hasOwnProperty("reload") && "yes" == e.reload && (sessionStorage.setItem("litespeed_docref", document.referrer), sessionStorage.setItem("litespeed_reloaded", "1"), window.location.reload(!0))
        }));
    </script>
    <script data-optimized="1" type="litespeed/javascript" data-src="https://abduldev.com/wp-content/litespeed/js/8a3c4231cbeb27ae5aa807efd8328d06.js?ver=5bd35"></script>